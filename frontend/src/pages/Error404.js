...
const Error404 = () => {
    return (
       <div className="error404 d-flex flex-column justify-content-center align-items-center">
            ...
            <h2 id="error" className="mb-4">ERROR 404!</h2>
            <h2 id="error" className="mb-4">Page not found</h2>
            <hr className="divider divider-light" />
            <Link id="botonCTA" className="btn btn-light btn-xl" to="/">BACK TO HOME</Link>
       </div>
    )
}
