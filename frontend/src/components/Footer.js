            ...
            <footer className="bg-light py-3">
                <div className="container d-flex flex-column">
                    <div className="row">
                        ...
                        <a href="facebook"><img className="redes-footer" src={facebook} alt="iconUser"></img></a>
                        <a href="instagram"><img className="redes-footer" src={instagram} alt="iconUser"></img></a>
                        <a href="pinterest"><img className="redes-footer" src={pinterest} alt="iconUser"></img></a>
                        <a href="twitter"><img className="redes-footer" src={twitter} alt="iconUser"></img></a>
                        </div>
