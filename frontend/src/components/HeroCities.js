            ...
            <div className="cities-header container px-4 px-lg-5">
                <div className="row gx-4 gx-lg-5 align-items-center justify-content-center text-center">
                    <div className="col-lg-12">
                        <h1 id="titleLogo" className="text-white font-weight-bold">The world <img className="logo2" src={logo} alt="logo"></img> is yours !</h1>
                    </div>
                </div>
            </div>
        </header>
        <header id="header" className="masthead d-xl-none" style={{ backgroundImage: `url('${backgroundimg}')` }}>
                <div className="container px-4 px-lg-5 h-100">
                    <div className="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                        <div className="col-lg-12 align-self-end pb-5">
                            <img className="logo" src={logo} alt="logo"></img>
                            <h1 id="titleLogo" className="text-white font-weight-bold pt-5">The world is yours!</h1>
                        </div>
                    </div>
                </div>
            </header>
